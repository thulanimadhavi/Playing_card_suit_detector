...
def load_ranks():
    ...
    for Rank in ['Ace','Two','Three','Four','Five','Six','Seven',
        ...
        filename = Rank + '.jpg'
        train_ranks[i].img = cv2.imread('C:/Users/thula/Desktop/OpenCV-Playing-Card-Detector-master/Card_Imgs/'+filename, cv2.IMREAD_GRAYSCALE)
...
def load_suits():
    ...
    for Suit in ['Spades','Diamonds','Clubs','Hearts']:
        ...
        train_suits[i].img = cv2.imread(
            'C:/Users/thula/Desktop/OpenCV-Playing-Card-Detector-master/Card_Imgs/' + filename, cv2.IMREAD_GRAYSCALE)
        i = i + 1
...
def draw_results(image, qCard):
    ...
    cv2.putText(image,suit_name,(x-60,y+25),font,1,(0,255,0),2,cv2.LINE_AA)
